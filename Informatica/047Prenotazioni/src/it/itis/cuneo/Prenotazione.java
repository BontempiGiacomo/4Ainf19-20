...
public class Prenotazione {
    ...
    private String data;
    private static final String PATH = ".\\src\\Csv\\prenotazione.csv";
    ...
    public String toCsv(){
        return cognome + SEPARATOR + nome + SEPARATOR + telefono + SEPARATOR + cittaPartenza + SEPARATOR + cittaDestinazione
                + SEPARATOR + data;
    }
