...
/**
 * Created by inf.bontempig3107 on 28/10/2019.
 */
    ...
    public class InputOutputUtility {
        ...
        //buffer contiene dati e legge i dati da tasiera attraverso l'InputStreamReader
        ...
        public static String leggiNome(String outStr){
            ...
            try {
                sc=br.readLine();    //prende i dati in input
            } catch (IOException e){ //eccezione input output
     ...
     * Legge la data ora per impostare una calendar
     * @param outStr: messaggio per l'utente
     * @param df: pattern di formato per la data  @param(sono delle direttive)
     * @return
     */
